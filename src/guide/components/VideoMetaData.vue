<template>
  <el-row>
    <ol v-if="srcElement">
      ...
      <li>
        dom size: {{ srcElement.clientWidth }}x{{ srcElement.clientHeight }}
      </li>
      <li>
        video size: {{ srcElement.videoWidth }}x{{ srcElement.videoHeight }}
      </li>
      <li>
        src:
        <el-link :href="srcElement.src" target="_blank">{{
          srcElement.src
        }}</el-link>
      </li>
      ...
      <li>
        ...
        {{ srcElement.webkitAudioDecodedByteCount }}
      </li>
      <li>
        webkitVideoDecodedByteCount:
        {{ srcElement.webkitVideoDecodedByteCount }}
      </li>
    </ol>
  </el-row>
</template>
