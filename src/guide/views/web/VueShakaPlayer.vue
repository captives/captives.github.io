<template>
    <el-main>
        ...
        <url-input v-model="url" :list="$videoList" @change="changeHandler"></url-input>
...
export default {
    ...
    mounted() {
        ...
        this.$videoList = [
            {
                label: "Dash 测试1",
                value: "https://dash.akamaized.net/dash264/TestCases/1c/qualcomm/2/MultiRate.mpd",
            },
            {
                label: "Dash 按需配置 ",
                value: "https://dash.akamaized.net/dash264/TestCases/1a/sony/SNE_DASH_SD_CASE1A_REVISED.mpd",
            },
            {
                label: "Dash 按需配置 ",
                value: "https://demo.unified-streaming.com/video/ateam/ateam.ism/ateam.mpd",
            },
            {
                label: "Dash 实时配置文件 ",
            ...
            {
                label: "Dash live 1",
                value: "https://cph-msl.akamaized.net/dash/live/2003285/test/manifest.mpd",
            },
            {
                label: "Dash live 2 具有认证",
                value: "https://cph-msl-ta.akamaized.net/dash/live/2003285/test/manifest.mpd?hdnts=st=1576841519~exp=1892201519~acl=/*~hmac=2cd04fd6efa7c852ac45aa0866366879e485319f68cca2cf7ecfcc1463d8db0d",
            },
            {
                label: "HLS 测试1",
            ...
            {
                label: "HLS 测试2",
                value: "https://cph-msl.akamaized.net/hls/live/2000341/test/master.m3u8",
            },
        ];
    },
    methods: {
        ...
        initPlayer(url) {
            ...
            const ui = new shaka.ui.Overlay(this.player, this.$refs.videoContainer.$el, video);
            ui.configure({
