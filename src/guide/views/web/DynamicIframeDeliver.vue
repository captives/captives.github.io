<template>
  <el-main>
    <el-row :gutter="10">
      ...
      <el-col :span="13" v-if="activateData">
        当前激活交互窗口{{activateData.id}}
        <el-button type="danger" @click="sendPageIframeHandler">发送指令</el-button>
      </el-col>
      <el-col :span="1">
        <el-button type="primary" tyle="small" @click="addHandler">增加</el-button>
      </el-col>
    </el-row>
    <el-carousel trigger="click" height="500px" :interval="60000">
      <el-carousel-item v-for="item in list" :key="item.id">
        <iframe :src="item.src" frameborder="0" :id="'iframe_' + item.id" :title="item.title"></iframe>
      </el-carousel-item>
    </el-carousel>
  </el-main>
</template>
