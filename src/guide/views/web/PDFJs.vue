    ...
    <el-container>
        <el-main v-loading="loading" class="center">
            ...
            <el-row class="control-bar">
                <el-col :span="20">
                    <el-pagination :page-size="1" :pager-count="7" layout="prev, pager, next" :hide-on-single-page="true" :total="pages" @current-change="init"></el-pagination>
                </el-col>
                <el-col :span="4">
...
page.render({ canvasContext: context, viewport: viewport });</pre>
            ...
            <p>
                4、<source-code :value="[{ value: 'webrtc/views/web/PDFJs.vue', lang: 'html' }]">查看源码</source-code>
            </p>
        </el-aside>
    </el-container>
</template>
