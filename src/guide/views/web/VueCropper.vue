    ...
    <el-main>
        <el-row :gutter="50">
            <el-col class="center" :xs="24" :sm="24" :md="12">
                ...
                <vue-cropper v-if="option.img" ref="cropper" class="viewport" :info="option.info" :infoTrue="true" :img="option.img" :output-size="option.outputSize" :output-type="option.outputType" :full="option.full" :fixed="option.fixed" :fixed-number="option.fixedNumber" :can-move="option.canMove" :can-move-box="option.canMoveBox" :fixed-box="option.fixedBox" :original="option.original" :auto-crop="option.autoCrop" :auto-crop-width="option.autoCropWidth" :auto-crop-height="option.autoCropHeight" :center-box="option.centerBox" :high="option.high" :enlarge="option.enlarge" mode="cover" @real-time="realTime" @img-load="imgLoad" @cropMoving="cropMovingHandler" @imgMoving="imgMovingHandler"></vue-cropper>

                <el-row v-if="option.img" style="padding-top: 2em">
                    <el-button icon="el-icon-picture" size="mini" type="success" @click="changeFixedNumber('4:3')">4:3</el-button>
                    <el-button icon="el-icon-picture" size="mini" type="success" @click="changeFixedNumber('1:1')">1:1</el-button>
                    <el-button icon="el-icon-picture" type="success" size="mini" @click="changeFixedNumber('2:3')">2:3</el-button>
                    <el-button icon="el-icon-picture" size="mini" type="success" @click="changeFixedNumber('16:9')">16:9</el-button>
                    ...
                    <el-button type="primary" icon="el-icon-zoom-in" size="mini" @click="changeScale(5)"></el-button>
                    <el-button type="primary" icon="el-icon-zoom-out" size="mini" @click="changeScale(-5)"></el-button>
                    <el-button icon="el-icon-tickets" size="mini" type="primary" @click="option.autoCropWidth = 800">800xAuto</el-button>
                    <el-button icon="el-icon-tickets" size="mini" type="primary" @click="option.autoCropWidth = 400">400xAuto</el-button>
                </el-row>

                <el-row style="padding-top: 2em">
                    <el-upload class="el-upload" action="#" accept=".png, .jpg, .jpeg, .bmp, .webp" :limit="1" :auto-upload="false" :show-file-list="false" :before-upload="beforeUploadHandler" :on-change="fileChangeHandler">
                        <el-button type="primary" icon="el-icon-picture"></el-button>
                    </el-upload>
                    <template v-if="option.img">
                        <el-button type="primary" icon="el-icon-delete" @click="clearCrop"></el-button>
                        <el-button type="primary" icon="el-icon-refresh" @click="refreshCrop"></el-button>
                        <el-button type="primary" icon="el-icon-edit-outline" @click="startCrop"></el-button>
                        <el-button type="primary" icon="el-icon-crop" @click="stopCrop"></el-button>
                        <el-button type="primary" @click="finish('base64')">base64预览</el-button>
                        <el-button type="primary" @click="finish('blob')">blob预览</el-button>
                    </template>
                </el-row>
            </el-col>
            ...
            <el-col :xs="24" :sm="24" :md="6">
                ...
                <p>
                    图片尺寸：{{ (previews.img && previews.img.width) || 0 }} - {{  (previews.img && previews.img.height) || 0 }}
                </p>
                <p>裁剪尺寸：{{ previews.w || 0 }}x{{ previews.h || 0 }}</p>
                <p>
                    输出尺寸：{{ previews.w * option.enlarge || 0 }}x{{ previews.h * option.enlarge || 0}}
                </p>
            ...
            <el-col :xs="24" :sm="24" :md="12">
                ...
                <el-form ref="form" :model="option" class="cropper" label-width="120px">
                    ...
                    <el-form-item label="原始宽高">
                        <el-tooltip content="上传图片是否显示原始宽高 (针对大图 可以铺满)" placement="top">
                    ...
                    <el-form-item label="截图框在图片内">
                        <el-tooltip content="截图框限制在图片内，只有在自动生成截图框时才能生效" placement="top">
