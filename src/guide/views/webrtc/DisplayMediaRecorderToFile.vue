  ...
  <el-main class="center">
    <el-row :gutter="50">
      <el-col class="center" :xs="24" :sm="24" :md="12">
        ...
        <video class="video-item" :srcObject.prop="localStream" autoplay></video>
      </el-col>
      <el-col class="center" :xs="24" :sm="24" :md="12">
        <el-divider content-position="left">录制</el-divider>
        <el-form :model="form" label-width="100px">
          <el-form-item label="文件名">
            <el-input v-model="form.name" clearable :disabled="form.connected"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            <el-button v-if="recording" type="danger" @click="stopRecorder">停止录制</el-button>
            <el-button v-else type="success" @click="startRecorder">开启录制</el-button>
          </el-form-item>
        </el-form>
      </el-col>
    </el-row>
      ...
      if ("WebSocket" in window) {
        if (this.form.connected) {
          ...
          ws.onopen = () => {
            ...
            ws.send(JSON.stringify({ event: 'register', name: this.form.name }));
          };
