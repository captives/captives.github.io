<template>
    <el-container class="center">
        <el-aside>
            <el-menu text-color="#fff" active-text-color="#ffd04b" background-color="#545c64" :collapse="isCollapse" :default-active="selectActive" @select="navSelectHandler">
        ...
        <el-main>
            <el-row :gutter="50">
                ...
                <el-col :span="12">
                    <el-cascader v-model="selectActive" :options="list" :props="{ label: 'name', value: 'path' }" @change="handleChange"></el-cascader>
                </el-col>
            </el-row>
        </el-main>
    </el-container>
