<template>
    <el-container>
        ...
        <el-aside width="500px">
            ...
            <p>{{ transform }}</p>
            <el-row class="footer">
                <el-button :type="isMatrix ? 'success' : 'danger'" size="mini" @click="isMatrix = !isMatrix">切换</el-button>
...
export default class Room extends Vue {
    ...
    private get transform() {
        ...
        this.styleObject.matrix = matrix
            ...
            .concat(skewMatrix)
            .concat(scaleMatrix);
        this.styleObject.matrixText = `transform: ${this.styleObject.matrix.toString()}; transition: ${this.styleObject.transition
