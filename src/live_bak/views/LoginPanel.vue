  ...
  <el-form :model="user" label-width="80px">
    ...
    <el-form-item label="角色: ">
      <el-select v-model="user.classType" placeholder="请选择橘色">
        <el-option
          v-for="{ label, value } in classTypes"
          :key="value"
          :label="label"
          :value="value"
        ></el-option>
    ...
    <el-form-item>
      <el-button type="success" @click="onSubmit(RoleType.PUBLISHER)"
        >老师进入</el-button
      >
      <el-button type="primary" @click="onSubmit(RoleType.SUBSCRIBER)"
        >学生进入</el-button
      >
    </el-form-item>
  </el-form>
...
export default {
  ...
  data() {
    return {
      logined: false,
      idList: [1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009],
      classList: [
        { label: "甘露班", td: 1001 },
        { label: "晨曦班", td: 1002 },
        { label: "花儿班", td: 1003 },
