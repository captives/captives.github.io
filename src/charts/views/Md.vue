<template>
    <el-main>
        <section class="page header">
            <h1 class="project-name">captive-admin-ui</h1>
            <h2 class="project-tagline">element ui</h2>
            <a href="https://github.com/Captives/captive-admin-ui" class="btn">View on GitHub</a>
        </section>
        <!--         <div class="md-page">
            <div class="main-content">
                ...
                <h2><a name="user-content-headers"></a><a id="user-content-headers" class="anchor" href="#headers" aria-hidden="true"><span class="octicon octicon-link"></span></a>Headers</h2>
...
<span class="p">[</span><span class="nv">Link</span><span class="p">](</span><span class="sx">url</span><span class="p">)</span> and !<span class="p">[</span><span class="nv">Image</span><span class="p">](</span><span class="sx">src</span><span class="p">)</span>
                ...
                <h2><a name="user-content-emphasis"></a><a id="user-content-emphasis" class="anchor" href="#emphasis" aria-hidden="true"><span class="octicon octicon-link"></span></a>Emphasis</h2>
...
Strikethrough uses two tildes. ~~Scratch this.~~
                ...
                <h2><a name="user-content-lists"></a><a id="user-content-lists" class="anchor" href="#lists" aria-hidden="true"><span class="octicon octicon-link"></span></a>Lists</h2>
...
and four to trigger the code block.
                ...
                <h2><a name="user-content-links"></a><a id="user-content-links" class="anchor" href="#links" aria-hidden="true"><span class="octicon octicon-link"></span></a>Links</h2>
...
[link text itself]: http://www.reddit.com
                ...
                <h2><a name="user-content-images"></a><a id="user-content-images" class="anchor" href="#images" aria-hidden="true"><span class="octicon octicon-link"></span></a>Images</h2>
...
[logo]: https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png "Logo Title Text 2"
                ...
                <p>Inline-style:
                    <img src="https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png" alt="alt text" title="Logo Title Text 1" style="max-width:100%;">
                </p>
                <p>Reference-style:
                    <img src="https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png" alt="alt text" title="Logo Title Text 2" style="max-width:100%;">
                </p>
                <p><a name="user-content-images"></a><a name="user-content-code"></a></p><a name="user-content-code">
                </a>
                <h2><a name="user-content-code"></a><a id="user-content-code-and-syntax-highlighting" class="anchor" href="#code-and-syntax-highlighting" aria-hidden="true"><span class="octicon octicon-link"></span></a>Code and Syntax Highlighting</h2>
...
But let's throw in a &lt;b&gt;tag&lt;/b&gt;.
                ...
                <h2><a name="user-content-tables"></a><a id="user-content-tables" class="anchor" href="#tables" aria-hidden="true"><span class="octicon octicon-link"></span></a>Tables</h2>
...
1 | 2 | 3
                ...
                <h2><a name="user-content-blockquotes"></a><a id="user-content-blockquotes" class="anchor" href="#blockquotes" aria-hidden="true"><span class="octicon octicon-link"></span></a>Blockquotes</h2>
...
&gt; This is a very long line that will still be quoted properly when it wraps. Oh boy let's keep writing to make sure this is long enough to actually wrap for everyone. Oh, you can *put* **Markdown** into a blockquote.
                ...
                <h2><a name="user-content-html"></a><a id="user-content-inline-html-1" class="anchor" href="#inline-html-1" aria-hidden="true"><span class="octicon octicon-link"></span></a>Inline HTML</h2>
...
&lt;/dl&gt;
                ...
                <h2><a name="user-content-hr"></a><a id="user-content-horizontal-rule" class="anchor" href="#horizontal-rule" aria-hidden="true"><span class="octicon octicon-link"></span></a>Horizontal Rule</h2>
...
Underscores
                ...
                <h2><a name="user-content-lines"></a><a id="user-content-line-breaks" class="anchor" href="#line-breaks" aria-hidden="true"><span class="octicon octicon-link"></span></a>Line Breaks</h2>
...
This line is only separated by a single newline, so it's a separate line in the *same paragraph*.
                ...
                <h2><a name="user-content-videos"></a><a id="user-content-youtube-videos" class="anchor" href="#youtube-videos" aria-hidden="true"><span class="octicon octicon-link"></span></a>Youtube videos</h2>
...
Lots of it...
                ...
                <p>Readability, however, is emphasized above all else. A Markdown-formatted
                    ...
                    filters -- including <a href="https://slashdot.org">Setext</a>, [atx] [2], [Textile] [3], [reStructuredText] [4],
                    [Grutatext] [5], and [EtText] [6] -- the single biggest source of
                    inspiration for Markdown's syntax is the format of plain text email.</p>
                <p><a href="https://slashdot.org">1</a>: <a href="http://docutils.sourceforge.net/mirror/setext.html">http://docutils.sourceforge.net/mirror/setext.html</a>
                ...
                <p>For example, to add an HTML table to a Markdown div:</p>
...
This is another regular paragraph.
                ...
                <p>Markdown allows you to use these characters naturally, taking care of
                    ...
                    into <code>&amp;amp;</code>.</p>
                <p>So, if you want to include a copyright symbol in your div, you can write:</p>
                <pre><code>&amp;copy;
</code></pre>
                ...
                <p>Markdown supports two styles of headers, <a href="https://slashdot.org">Setext</a> and [atx] [2].</p>
...
&lt;/div&gt;
                ...
                <div class="highlight highlight-js">
                    <pre><span class="pl-k">var</span> gulp <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">'</span>gulp<span class="pl-pds">'</span></span>);
            ...
            <div class="toc-block">
                <ul>
                    <ul>
                        ...
                        <ul>
                            <li><a href="#JavaScript事件的三阶段">JavaScript事件的三阶段</a></li>
                        </ul>
                        <li><a href="#事件修饰符">事件修饰符</a></li>
                        <li><a href="#自定义事件">自定义事件</a></li>
                        <ul>
                            <li><a href="#验证抛出的事件">验证抛出的事件</a></li>
                        </ul>
                        <li><a href="#v-model">v-model</a></li>
                        <ul>
                            <li><a href="#v-model 参数">v-model 参数</a></li>
                            <li><a href="#多个 v-model 绑定">多个 v-model 绑定</a></li>
                            <li><a href="#处理 v-model 修饰符">处理 v-model 修饰符</a></li>
                        </ul>
                    </ul>
                </ul>
            </div>
            <pre><div class="hljs"><code class=" language-js">_<span class="token punctuation">.</span><span class="token function">add</span><span class="token punctuation">(</span><span class="token number">6</span><span class="token punctuation">,</span> <span class="token number">4</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token comment">// =&gt; 10</span>
</code></div></pre>

            <div class="code">
                <p>console</p><code class="  language-console">ping localhost</code>
            </div>
            <div class="code">
                <p>bash</p><code class="  language-bash">ping localhost</code>
            </div>
            <div class="code">
                <p>sh</p><code class="  language-sh">ping localhost</code>
            </div>
            <div class="code">
                <p>cmd</p><code class="  language-cmd">ping localhost</code>
            </div>
            <h3><a id="JavaScript事件的三阶段"></a>JavaScript事件的三阶段</h3>
            <p><img src="assets/logo.png" alt="aHR0cHM6Ly93d3cud2FuZ3lhbmFuLm9ubGluZTo4MDAwL21lZGlhLzIwMTkvMDkvZXZlbnQucG5n.png"></p>
            <a class="btn">这是按钮</a>
            <ol>
                <li>捕获阶段</li>
                <li>目标阶段：执行当前对象的事件处理程序</li>
                <li>冒泡阶段</li>
            </ol>
            <div class="more-block">
                <details>
                    ...
                    <ul>
                        <li>阻止事件冒泡： <code>event.stopPropagation()</code> 或 <code>event.cancelBubble = true (IE)</code></li>
            ...
            <h2><a id="事件修饰符"></a>事件修饰符</h2>
            <p><a href="https://cn.vuejs.org/v2/guide/events.html#%E4%BA%8B%E4%BB%B6%E4%BF%AE%E9%A5%B0%E7%AC%A6" target="_blank">查看文档</a></p>
            <p>在事件处理程序中调用<code>event.preventDefault()</code>或<code>event.stopPropagation()</code>是非常常见的需求。尽管我们可以在方法中轻松实现这点，但更好的方式是：<strong>方法只有纯粹的数据逻辑，而不是去处理 DOM 事件细节</strong>。</p>
            <p>为了解决这个问题，Vue.js 为<code>v-on</code>提供了事件修饰符。修饰符是由点开头的指令后缀来表示的。</p>
            <ul>
                ...
                <li><code>.enter</code> 只有在<code>key</code>是<code>Enter</code>时调用<code>vm.submit()</code></li>
            </ul>
            <div class="tip-block info"><span class="title"> 键盘事件修饰符 </span>
                <p><code>.tab</code>、<code>.esc</code>、<code>.space</code>、<code>.up</code>、<code>.down</code>、<code>.left</code>、<code>.right</code>、<code>.delete</code> (捕获“删除”和“退格”键)等等</p>
            </div>
            <p>示例：</p>
            <ul>
                <li>@click.stop : 阻止事件冒泡</li>
                <li>@click.prevent : 阻止事件默认行为</li>
                <li>@click.self : 事件只作用在元素本身，而不是其子元素</li>
                <li>@click.capture : 使用事件捕获模式</li>
                <li>@click.once : 事件只触发一次 2.1.4新增</li>
                <li>@scroll.passive : 告诉浏览器这个事件的默认行为不会被取消 2.3.0新增</li>
                <li>@keyup.enter : 按键修饰符，enter被按下的时候触发</li>
                <li>@click.ctrl : 系统修饰符，Ctrl 被按下的时候触发 2.1.0新增</li>
                <li>@click.ctrl.exact : 有且只有 Ctrl 被按下的时候才触发 2.5.0新增</li>
            </ul>
            <div class="tip-block error">
            ...
            <h2><a id="自定义事件"></a>自定义事件</h2>
            <p><a href="https://v3.cn.vuejs.org/guide/component-custom-events.html#%E5%AE%9A%E4%B9%89%E8%87%AA%E5%AE%9A%E4%B9%89%E4%BA%8B%E4%BB%B6" target="_blank">查看文档</a></p>
            <p>可以通过<code>emits</code>选项在组件上定义已发出的事件。</p>
            <pre><div class="hljs"><code class=" language-js">app<span class="token punctuation">.</span><span class="token function">component</span><span class="token punctuation">(</span><span class="token string">'custom-form'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
            ...
            <div class="tip-block info"><span class="title"> Tip </span>
                <p>建议定义所有发出的事件，以便更好地记录组件应该如何工作。</p>
            </div>
            <h3><a id="验证抛出的事件"></a>验证抛出的事件</h3>
            <p>与<code>prop</code>类型验证类似，如果使用<strong>对象语法</strong>而不是<strong>数组语法</strong>定义发出的事件，则可以验证它。</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
            ...
            <h2><a id="v-model"></a>v-model</h2>
            <h3><a id="v-model 参数"></a>v-model 参数</h3>
            <p><a href="https://v3.cn.vuejs.org/guide/component-custom-events.html#v-model-%E5%8F%82%E6%95%B0" target="_blank">查看文档</a></p>
            <p>默认情况下，组件上的<code>v-model</code>使用<code>modelValue</code>作为 prop 和<code>update:modelValue</code>作为事件。我们可以通过向<code>v-model</code>传递参数来修改这些名称：</p>
            <pre><div class="hljs"><code class=" language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>my-component</span> <span class="token attr-name"><span class="token namespace">v-model:</span>title</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>bookTitle<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>my-component</span><span class="token punctuation">&gt;</span></span>
</code></div></pre>
            <pre><div class="hljs"><code class=" language-js">app<span class="token punctuation">.</span><span class="token function">component</span><span class="token punctuation">(</span><span class="token string">'my-component'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
            ...
            <h3><a id="多个 v-model 绑定"></a>多个 v-model 绑定</h3>
            <p><a href="https://v3.cn.vuejs.org/guide/component-custom-events.html#%E5%A4%9A%E4%B8%AA-v-model-%E7%BB%91%E5%AE%9A" target="_blank">查看文档</a></p>
            <p>通过利用以特定 prop 和事件为目标的能力，正如我们之前在<code>v-model</code>参数中所学的那样，我们现在可以在单个组件实例上创建多个<code>v-model</code>绑定。</p>
            <p>每个<code>v-model</code>将同步到不同的 prop，而不需要在组件中添加额外的选项：</p>
            <h3><a id="处理 v-model 修饰符"></a>处理 v-model 修饰符</h3>
            <p><a href="https://v3.cn.vuejs.org/guide/component-custom-events.html#%E5%A4%84%E7%90%86-v-model-%E4%BF%AE%E9%A5%B0%E7%AC%A6" target="_blank">查看文档</a></p>
            <p>学习表单输入绑定时，我们看到<code>v-model</code>有内置修饰符——<code>.trim</code>、<code>.number</code>和<code>.lazy</code>。但是，在某些情况下，你可能还需要添加自己的自定义修饰符。</p>
            <pre><div class="hljs"><code class=" language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>app<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
            ...
            <pre><div class="hljs"><code class=" language-js"><span class="token keyword">const</span> app <span class="token operator">=</span> Vue<span class="token punctuation">.</span><span class="token function">createApp</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
app<span class="token punctuation">.</span><span class="token function">mount</span><span class="token punctuation">(</span><span class="token string">'#app'</span><span class="token punctuation">)</span>
            ...
            <p>添加到组件<code>v-model</code>的修饰符将通过<code>modelModifiers</code> prop 提供给组件。每当<code> &lt;input/&gt;</code>元素触发<code>input</code>事件时，我们都将字符串大写。<br>
                请注意，当组件的 created 生命周期钩子触发时，<code>modelModifiers</code>prop 会包含<code>capitalize</code>，且其值为 true<br>
                ——因为<code>capitalize</code>被设置在了写为``的 v-model 绑定上。</p>
            <div class="tip-block info">
                <p>对于带参数的 v-model 绑定，生成的 prop 名称将为 arg + “Modifiers”：</p>
            </div>
            <pre><div class="hljs"><code class=" language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>my-component</span> <span class="token attr-name"><span class="token namespace">v-model:</span>description.capitalize</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>myText<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>my-component</span><span class="token punctuation">&gt;</span></span>
</code></div></pre>
            <pre><div class="hljs"><code class=" language-js">app<span class="token punctuation">.</span><span class="token function">component</span><span class="token punctuation">(</span><span class="token string">'my-component'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
            ...
            <video src="assets/medias/cherry_town.mp4" muted autoplay loop style="height:320px"></video>
            <audio src="assets/medias/jinli.mp3" autoplay loop>
                您的浏览器不支持 audio 标签。</audio>
        </div>
        <!-- </div> -->
        <footer class="page footer">

            <span class="site-footer-owner"><a href="https://github.com/Captives/captive-admin-ui">captive-admin-ui</a> is maintained by <a href="https://github.com/Captives">Captives</a>.</span>
